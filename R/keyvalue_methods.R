...
#'
#' Objects of type \code{keyvalue11} are summarized as data.frames with an additional display of possible
...
#' @param ... ignored
#' @return A list with three elements: a summary of the underlying data.frame,
